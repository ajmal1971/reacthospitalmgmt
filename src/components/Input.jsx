...
const Input = React.forwardRef(function Input ({label, type = 'text', className = '', ...props}, ref) {
    ...
    return (
        <div className='w-full'>
            ...
            <input type={type} className={`shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none ${className}`} ref={ref} {...props} id={id}/>
        </div>
    );
});
